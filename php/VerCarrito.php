     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
         ...
         <div id="my-nav" class="collapse navbar-collapse">
             <ul class="navbar-nav mr-auto">
                 <li class="nav-item">
                     <a class="nav-link disabled" href="../inicio.php">Inicio<span class="sr-only">(current)</span></a>
                 </li>
                 <li class="nav-item active">
                     <a class="nav-link " href="#" tabindex="-1" aria-disabled="true">Carrito</a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link disabled" href="pagos.php" tabindex="-1" aria-disabled="true">Pagos</a>
                 </li>
             </ul>
         </div>
     </nav>
             ...
             <table class="table">
                 ...
                 <tbody>
                     <?php
                        ...
                        ?>
                                 <tr>
                                     <td><input type="text" value="<?php echo $item['marca']; ?>" name="marca"></td>
                                     <td><?php echo $item['precioVenta']; ?></td>
                                     <td><input type='number' onchange='actualizarCantidad(this,<?php echo $item["id"]; ?>);' value="<?php echo $item['cantidad']; ?>" name="cantidad" /> </td>
