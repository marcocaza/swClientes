    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="php/VerCarrito.php" tabindex="-1" aria-disabled="true">Carrito</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link disabled" href="php/pagos.php" tabindex="-1" aria-disabled="true">Pagos</a>
                </li>
                <?php
