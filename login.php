  ...
  <body>
    ...
    <?php
      ...
      <div class="alert alert-primary" role="alert">
          <center><img src="img/logo1.png" alt="car1" id="logo1">Login<img src="img/logo2.png" alt="car2" id="logo2"></center> 
      </div>
		...
		<div class="card">
			...
			<div class="card-body">
				<form>
                    ...
                    <center>
						<input type="submit" value="Ingresar" name="login" class="btn float-right login_btn">
                        </center>
					</div>
				</form>
			</div>
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					¿No tienes una cuenta?<a href="clientes.php">Registro</a>
				</div>
